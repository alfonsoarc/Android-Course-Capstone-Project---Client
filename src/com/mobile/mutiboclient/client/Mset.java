 ...
 * associated images for each movie, information identifying the one movie that
 * is not like the other three, and accompanying text, explaining the
 * relationship between the three related movies.
 */
public class Mset {
	private long id;
	...
	// Negative ratings (less than 3 stars)
	private long negatives;

	public Mset() {
	}

	public Mset(ArrayList<String> movies, int unrelatedMovieIndex,
			String relationshipExplanation) {
		super();
		this.movies = movies;
	...
	/**
	 * Two Msets are considered equal if they have exactly the same movies and
	 * the index of the unrelated movie is the same
	 * 
	 */
	@Override

 ...
 * client requests.
 * 
 * It can be used it like this:
 * 
 * private MutiboSvcApi mutiboService = new SecuredRestBuilder()
 * .setLoginEndpoint(TEST_URL + MutiboSvcApi.TOKEN_PATH) .setUsername(USERNAME)
...
public class SecuredRestBuilder extends RestAdapter.Builder {
	...
	private static MutiboSvcApi mutiboService;
	private final static String TEST_URL = "https://192.168.1.8:8443";
	...
	public static MutiboSvcApi getMutiboService() {
		return mutiboService;
	}

	public static void createMutiboService(String username, String password) {
		mutiboService = new SecuredRestBuilder()
